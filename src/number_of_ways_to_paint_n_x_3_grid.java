...
public class number_of_ways_to_paint_n_x_3_grid {
...
*   RGY YGY GYG
*
*   R for RED, G for GREEN and Y for YELLOW
...
*/
    ...
    public static void main(String [] args){
        ...
        number_of_ways_to_paint_n_x_3_grid n=new number_of_ways_to_paint_n_x_3_grid();

        int number=n.numOfWays(size);

        System.out.println(n.numOfWays(size));
